---
title: "O que os italianos me ensinaram sobre luz"
subtitle: "Notas de uma tarde na PUC Minas Lourdes, falando sobre luz como intenção, não como infraestrutura."
description: "Uma nota de método a partir de uma palestra pública sobre lighting design no Italian Design Day em Belo Horizonte — sobre disciplina, intenção, e o que a manufatura italiana ensina sobre a ordem em que as decisões são tomadas."
...
<div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;margin:0 0 2.5rem;background:var(--sand);">
  <iframe
    ...
    allowfullscreen
    title="Palestra no Italian Design Day, PUC Minas Lourdes">
  </iframe>
</div>
...
<strong>A Itália não inventou a luz. A Itália aprendeu a respeitá-la.</strong>
...
Projeto de iluminação começa muito antes — numa decisão sobre o que o ambiente é, <em>para que</em> ele serve, e como um corpo vai atravessá-lo nas diferentes horas do dia. A peça vem por último. Nunca primeiro.
...
Não como novidade tecnológica. Como a aplicação mais simples possível de um princípio: <em>a luz precisa saber que horas são</em>. O corpo sabe. A lâmpada tem que acompanhar.
...
A troca com os estudantes depois foi a parte da tarde que vou guardar. Estudante de arquitetura ainda faz a pergunta que cliente pagante já aprendeu a não fazer. Quer saber <em>por que</em> uma coisa é feita, não se ela está na moda. Quer o princípio, não a tendência.
...
<em>Obrigada ao Consulado da Itália em Belo Horizonte, à CASACOR Minas, à PUC Minas, à Stefania Leone, e aos estudantes que ficaram para a conversa que importava.</em>

Se você está construindo uma prática que leva a luz a sério — ou contratando alguém para liderar esse trabalho — escreva para [iarasantos.is@icloud.com](mailto:iarasantos.is@icloud.com).
